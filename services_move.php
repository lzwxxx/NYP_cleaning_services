<?php
   require_once("connection.php");
    $sql = "SELECT * FROM services WHERE categoryID = '4'";
...
<head>
    ...
    <link rel="stylesheet" href="css/services_move.css"> 
...
<body>
    ...
    <section id="s1">
       <div id="s1_1">
           <h1>MOVING IN/OUT RENOVATION</h1>
       </div>
        <p>Our Moving In/Out Cleaning is a thorough cleaning done before you move in to your new home or when you are returning the apartment to your landlord after tenancy.</p> 
    </section>
    ...
    <section id="s2">
            <h2>MOVE IN/OUT CLEANING INCLUDES&#58;</h2>
            <ul id="s2_1">
               <div class="s2_2">
                    <li>Sweeping, mopping and vacuuming of floors</li>
                    <li>Cleaning of wardrobe external &#40;internal if empty&#41;</li>
                    <li>Dusting and Wiping exterior of electrical appliances</li>
                    <li>Cleaning and polishing of mirrors</li>
                    <li>Wipe glass windows &amp; metal grilles</li>
                    <li>Wiping of furniture &#40;internal if empty&#41;</li>
               </div> 
                <div class="s2_2">
                    <li>Disinfecting of basin</li>
                    <li>Clean doors and door grilles &#40;if any&#41;</li>
                    <li>Wash &amp; Scrub kitchen &amp; toilet floor</li>
                    <li>Wiping of cooking stove and exterior of cooking appliances</li>
                    <li>Wipe all fans &amp; air-con external units</li>
                    <li>Wiping and cleaning of all ceiling fans and lights</li>
                </div>
            </ul>
    </section>
